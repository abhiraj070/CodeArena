...
import { login, register, pastConnectedUsers, getUserByUsername, getUserById, getRecentlyConnectedUsers, getChatsWithUsers, updatePreferredLanguage, updateProfile, updateUserOnlineStatus } from "../controllers/user.controller.js";
...
router.route("/details/:id").get(VerifyJWT, getUserById)
